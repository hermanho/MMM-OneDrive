...
/*! @azure/msal-node v3.8.0 2025-09-24 */ class Serializer {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ const Constants$2 = {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ const DEFAULT_CRYPTO_IMPLEMENTATION = {
  createNewGuid: () => {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ var LogLevel;
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ class StringUtils {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ class ScopeSet {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ function tenantIdMatchesHomeTenant(tenantId, homeAccountId) {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ function extractTokenClaims(encodedToken, base64Decode) {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ function getDeserializedResponse(responseString) {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ class UrlString {
  get urlString() {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ const EndpointMetadata = {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ InstanceDiscoveryMetadata.metadata.forEach(metadataEntry => {
...
class CacheManager {
  constructor(clientId, cryptoImpl, logger, performanceClient, staticAuthorityOptions) {
    this.clientId = clientId, this.cryptoImpl = cryptoImpl, this.commonLogger = logger.clone("@azure/msal-common", "15.13.0"), 
  ...
  async saveCacheRecord(cacheRecord, correlationId, storeInCache) {
    ...
    try {
      cacheRecord.account && await this.setAccount(cacheRecord.account, correlationId), 
      cacheRecord.idToken && !1 !== storeInCache?.idToken && await this.setIdTokenCredential(cacheRecord.idToken, correlationId), 
      cacheRecord.accessToken && !1 !== storeInCache?.accessToken && await this.saveAccessToken(cacheRecord.accessToken, correlationId), 
      cacheRecord.refreshToken && !1 !== storeInCache?.refreshToken && await this.setRefreshTokenCredential(cacheRecord.refreshToken, correlationId), 
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ const DEFAULT_SYSTEM_OPTIONS$1 = {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ const CcsCredentialType_HOME_ACCOUNT_ID = "home_account_id", CcsCredentialType_UPN = "UPN";

/*! @azure/msal-common v15.13.0 2025-09-24 */ function buildClientInfo(rawClientInfo, base64Decode) {
  if (!rawClientInfo) {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ const RETURN_SPA_CODE = "return_spa_code", X_CLIENT_EXTRA_SKU = "x-client-xtra-sku";
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ const AuthorityType_Default = 0, AuthorityType_Adfs = 1, AuthorityType_Dsts = 2, AuthorityType_Ciam = 3;
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ function isCredentialEntity(entity) {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ RegionDiscovery.IMDS_OPTIONS = {
  headers: {
    Metadata: "true"
  }
};
...
class Authority {
  ...
  async getEndpointMetadataFromNetwork() {
    ...
    try {
      ...
      /*! @azure/msal-common v15.13.0 2025-09-24 */ (response.body);
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ Authority.reservedTenantDomains = new Set([ "{tenant}", "{tenantid}", AADAuthorityConstants_COMMON, AADAuthorityConstants_CONSUMERS, AADAuthorityConstants_ORGANIZATIONS ]);
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ function getRequestThumbprint(clientId, request, homeAccountId) {
  return {
    clientId: clientId,
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ class ThrottlingUtils {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ class NetworkError extends AuthError {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ class BaseClient {
  constructor(configuration, performanceClient) {
    this.config = function({authOptions: userAuthOptions, systemOptions: userSystemOptions, loggerOptions: userLoggerOption, cacheOptions: userCacheOptions, storageInterface: storageImplementation, networkInterface: networkImplementation, cryptoInterface: cryptoImplementation, clientCredentials: clientCredentials, libraryInfo: libraryInfo, telemetry: telemetry, serverTelemetryManager: serverTelemetryManager, persistencePlugin: persistencePlugin, serializableCache: serializableCache}) {
      ...
      var authOptions;
    }(configuration), this.logger = new Logger(this.config.loggerOptions, "@azure/msal-common", "15.13.0"), 
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ function getTenantIdFromIdTokenClaims(idTokenClaims) {
  if (idTokenClaims) {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ class AccountEntity {
  getAccountInfo() {
    return {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ const noTokensFound = "no_tokens_found", nativeAccountUnavailable = "native_account_unavailable", refreshTokenExpired = "refresh_token_expired", uxNotAllowed = "ux_not_allowed", badToken = "bad_token", InteractionRequiredServerErrorMessage = [ "interaction_required", "consent_required", "login_required", "bad_token", "ux_not_allowed" ], InteractionRequiredAuthSubErrorMessage = [ "message_only", "additional_action", "basic_action", "user_password_expired", "consent_required", "bad_token" ], InteractionRequiredAuthErrorMessages = {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ class ProtocolUtils {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ const KeyLocation_SW = "sw";
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ class TokenCacheContext {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ class ResponseHandler {
  ...
  generateCacheRecord(serverTokenResponse, authority, reqTimestamp, request, idTokenClaims, userAssertionHash, authCodePayload) {
    ...
    /*! @azure/msal-common v15.13.0 2025-09-24 */ (this.cacheStorage, authority, this.homeAccountIdentifier, this.cryptoObj.base64Decode, request.correlationId, idTokenClaims, serverTokenResponse.client_info, env, claimsTenantId, authCodePayload, void 0, this.logger));
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ class AuthorizationCodeClient extends BaseClient {
  constructor(configuration, performanceClient) {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ class RefreshTokenClient extends BaseClient {
  constructor(configuration, performanceClient) {
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ class SilentFlowClient extends BaseClient {
  constructor(configuration, performanceClient) {
    super(configuration, performanceClient);
  }
...
/*! @azure/msal-common v15.13.0 2025-09-24 */ function getStandardAuthorizeRequestParameters(authOptions, request, logger, performanceClient) {
  ...
  function(parameters, responseMode) {
    ...
    if (request.sid && request.prompt === PromptValue_NONE) {
      ...
      /*! @azure/msal-common v15.13.0 2025-09-24 */ (request.account);
...
/*! @azure/msal-node v3.8.0 2025-09-24 */ class Deserializer {
...
/*! @azure/msal-node v3.8.0 2025-09-24 */ const HttpMethod_GET = "get", HttpMethod_POST = "post", ProxyStatus = {
...
/*! @azure/msal-node v3.8.0 2025-09-24 */ class HttpClient {
...
/*! @azure/msal-node v3.8.0 2025-09-24 */ const DEFAULT_AUTH_OPTIONS = {
...
/*! @azure/msal-node v3.8.0 2025-09-24 */ class GuidGenerator {
  generateGuid() {
    return v4();
  }
  isGuid(guid) {
...
/*! @azure/msal-node v3.8.0 2025-09-24 */ class EncodingUtils {
...
/*! @azure/msal-node v3.8.0 2025-09-24 */ class HashUtils {
  sha256(buffer) {
    return crypto$1.createHash(Hash_SHA256).update(buffer).digest();
  }
}

/*! @azure/msal-node v3.8.0 2025-09-24 */ class PkceGenerator {
  constructor() {
...
/*! @azure/msal-node v3.8.0 2025-09-24 */ class CryptoProvider {
  constructor() {
...
/*! @azure/msal-node v3.8.0 2025-09-24 */ const defaultSerializedCache_Account = {}, defaultSerializedCache_IdToken = {}, defaultSerializedCache_AccessToken = {}, defaultSerializedCache_RefreshToken = {}, defaultSerializedCache_AppMetadata = {};
...
/*! @azure/msal-node v3.8.0 2025-09-24 */ function getAuthCodeRequestUrl(config, authority, request, logger) {
...
/*! @azure/msal-node v3.8.0 2025-09-24 */ class ClientApplication {
  constructor(configuration) {
    ...
    }(configuration), this.cryptoProvider = new CryptoProvider, this.logger = new Logger(this.config.system.loggerOptions, "@azure/msal-node", "3.8.0"), 
...
/*! @azure/msal-node v3.8.0 2025-09-24 */ class LoopbackClient {
...
/*! @azure/msal-node v3.8.0 2025-09-24 */ class DeviceCodeClient extends BaseClient {
  constructor(configuration) {
    super(configuration);
  }
  async acquireToken(request) {
...
/*! @azure/msal-node v3.8.0 2025-09-24 */ class PublicClientApplication extends ClientApplication {
  constructor(configuration) {
...
/*! @azure/msal-node v3.8.0 2025-09-24 */ process.env.ProgramData, process.env.ProgramFiles;
