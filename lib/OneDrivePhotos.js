...
/*! @azure/msal-node v5.4.0 2026-07-07 */ class Serializer {
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ class ClientAuthError extends AuthError {
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ const methodNotImplemented = "method_not_implemented";
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ function extractTokenClaims(encodedToken, base64Decode, correlationId) {
  ...
  /*! @azure/msal-common v16.11.1 2026-07-07 */ (encodedToken, correlationId);
  try {
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ const AuthorityType_Default = 0, AuthorityType_Adfs = 1, AuthorityType_Dsts = 2, AuthorityType_Ciam = 3;

/*! @azure/msal-common v16.11.1 2026-07-07 */ function getTenantIdFromIdTokenClaims(idTokenClaims) {
  if (idTokenClaims) {
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ const ProtocolMode_AAD = "AAD", ProtocolMode_OIDC = "OIDC";

/*! @azure/msal-common v16.11.1 2026-07-07 */ function getAccountInfo(accountEntity) {
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ class UrlString {
  get urlString() {
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ const rawMetdataJSON = {
  endpointMetadata: [ {
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ InstanceDiscoveryMetadata.metadata.forEach(metadataEntry => {
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ function isCredentialEntity(entity) {
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ RegionDiscovery.IMDS_OPTIONS = {
  headers: {
    Metadata: "true"
  }
};
...
class Authority {
  ...
  async getCloudDiscoveryMetadataFromNetwork() {
    ...
    try {
      ...
      /*! @azure/msal-common v16.11.1 2026-07-07 */ (response.body)) {
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ Authority.reservedTenantDomains = new Set([ "{tenant}", "{tenantid}", AADAuthority_COMMON, AADAuthority_CONSUMERS, AADAuthority_ORGANIZATIONS ]);
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ function instrumentBrokerParams(parameters, correlationId, performanceClient) {
  if (!correlationId) {
    return;
  }
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ function getDeserializedResponse(responseString) {
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ const DEFAULT_CRYPTO_IMPLEMENTATION = {
  createNewGuid: () => {
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ var LogLevel;
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ const name$1 = "@azure/msal-common";
...
class CacheManager {
  constructor(clientId, cryptoImpl, logger, performanceClient, staticAuthorityOptions) {
    this.clientId = clientId, this.cryptoImpl = cryptoImpl, this.commonLogger = logger.clone(name$1, "16.11.1"), 
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ const PerformanceEventStatus_InProgress = 1;

/*! @azure/msal-common v16.11.1 2026-07-07 */ class StubPerformanceClient {
  generateId() {
    return "callback-id";
  }
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ const DEFAULT_SYSTEM_OPTIONS$1 = {
...
function buildClientConfiguration({authOptions: userAuthOptions, systemOptions: userSystemOptions, loggerOptions: userLoggerOption, storageInterface: storageImplementation, networkInterface: networkImplementation, cryptoInterface: cryptoImplementation, clientCredentials: clientCredentials, libraryInfo: libraryInfo, telemetry: telemetry, serverTelemetryManager: serverTelemetryManager, persistencePlugin: persistencePlugin, serializableCache: serializableCache}) {
  ...
  return {
    ...
    storageInterface: storageImplementation || new DefaultStorageClass(userAuthOptions.clientId, DEFAULT_CRYPTO_IMPLEMENTATION, new Logger(loggerOptions, name$1, "16.11.1"), new StubPerformanceClient),
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ class TokenCacheContext {
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ const KeyLocation_SW = "sw";
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ class ServerError extends AuthError {
...
class ResponseHandler {
  ...
  async handleServerTokenResponse(serverTokenResponse, authority, reqTimestamp, request, apiId, authCodePayload, userAssertionHash, handlingRefreshTokenResponse, forceCacheRefreshTokenResponse, serverRequestId, additionalCacheKeyComponents) {
    ...
    }(this.cryptoObj.base64Decode, authCodePayload.state, request.correlationId)), serverTokenResponse.key_id = serverTokenResponse.key_id || request.sshKid || void 0;
  ...
  generateCacheRecord(serverTokenResponse, authority, reqTimestamp, request, idTokenClaims, userAssertionHash, authCodePayload, additionalCacheKeyComponents) {
    ...
    /*! @azure/msal-common v16.11.1 2026-07-07 */ (this.cacheStorage, authority, this.homeAccountIdentifier, this.cryptoObj.base64Decode, request.correlationId, idTokenClaims, serverTokenResponse.client_info, env, claimsTenantId, authCodePayload, void 0, this.logger, this.performanceClient));
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ async function getClientAssertion(clientAssertion, clientId, tokenEndpoint, fmiPath) {
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ function getRequestThumbprint(clientId, request, homeAccountId) {
  return {
    clientId: clientId,
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ class ThrottlingUtils {
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ class NetworkError extends AuthError {
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ class AuthorizationCodeClient {
  constructor(configuration, performanceClient) {
    this.includeRedirectUri = !0, this.config = buildClientConfiguration(configuration), 
    this.logger = new Logger(this.config.loggerOptions, name$1, "16.11.1"), this.cryptoUtils = this.config.cryptoInterface, 
  ...
  async createTokenRequestBody(request) {
    ...
    addResource(parameters, request.resource), function(parameters, code) {
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ function getStandardAuthorizeRequestParameters(authOptions, request, logger, performanceClient) {
  ...
  addCorrelationId(parameters, correlationId), function(parameters, responseMode) {
    ...
    if (request.sid && request.prompt === PromptValue_NONE) {
      ...
      /*! @azure/msal-common v16.11.1 2026-07-07 */ (request.account);
...
class RefreshTokenClient {
  constructor(configuration, performanceClient) {
    this.config = buildClientConfiguration(configuration), this.logger = new Logger(this.config.loggerOptions, name$1, "16.11.1"), 
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ function makeExtraSkuString(params) {
...
/*! @azure/msal-common v16.11.1 2026-07-07 */ class SilentFlowClient {
  constructor(configuration, performanceClient) {
    this.config = buildClientConfiguration(configuration), this.logger = new Logger(this.config.loggerOptions, name$1, "16.11.1"), 
    this.cryptoUtils = this.config.cryptoInterface, this.cacheManager = this.config.storageInterface, 
    this.networkClient = this.config.networkInterface, this.serverTelemetryManager = this.config.serverTelemetryManager, 
  ...
  async generateResultFromCacheRecord(cacheRecord, request) {
    ...
    ResponseHandler.generateAuthenticationResult(this.cryptoUtils, this.authority, cacheRecord, !0, request, this.performanceClient, idTokenClaims);
  }
}

/*! @azure/msal-common v16.11.1 2026-07-07 */ function enforceResourceParameter(isMcp, request) {
  if (isMcp) {
...
/*! @azure/msal-node v5.4.0 2026-07-07 */ class Deserializer {
...
/*! @azure/msal-node v5.4.0 2026-07-07 */ const NodeAuthErrorMessage_invalidLoopbackAddressType = {
...
/*! @azure/msal-node v5.4.0 2026-07-07 */ const DEFAULT_AUTH_OPTIONS = {
  clientId: "",
...
/*! @azure/msal-node v5.4.0 2026-07-07 */ class EncodingUtils {
...
/*! @azure/msal-node v5.4.0 2026-07-07 */ class HashUtils {
  sha256(buffer) {
    return crypto$1.createHash(Hash_SHA256).update(buffer).digest();
  }
}

/*! @azure/msal-node v5.4.0 2026-07-07 */ class PkceGenerator {
  constructor() {
...
/*! @azure/msal-node v5.4.0 2026-07-07 */ class CryptoProvider {
  constructor() {
...
/*! @azure/msal-node v5.4.0 2026-07-07 */ function generateCredentialKey(credential) {
  ...
  return credential.additionalCacheKeyComponents && Object.keys(credential.additionalCacheKeyComponents).length > 0 && credentialKey.push(function(components) {
...
/*! @azure/msal-node v5.4.0 2026-07-07 */ const defaultSerializedCache_Account = {}, defaultSerializedCache_IdToken = {}, defaultSerializedCache_AccessToken = {}, defaultSerializedCache_RefreshToken = {}, defaultSerializedCache_AppMetadata = {};
...
/*! @azure/msal-node v5.4.0 2026-07-07 */ const name = "@azure/msal-node";

/*! @azure/msal-node v5.4.0 2026-07-07 */
class BaseClient {
  constructor(configuration) {
    this.config = buildClientConfiguration(configuration), this.logger = new Logger(this.config.loggerOptions, name, "5.4.0"), 
    this.cryptoUtils = this.config.cryptoInterface, this.cacheManager = this.config.storageInterface, 
    this.networkClient = this.config.networkInterface, this.serverTelemetryManager = this.config.serverTelemetryManager, 
...
/*! @azure/msal-node v5.4.0 2026-07-07 */ class UsernamePasswordClient extends BaseClient {
  constructor(configuration) {
    super(configuration);
  }
...
/*! @azure/msal-node v5.4.0 2026-07-07 */ function getAuthCodeRequestUrl(config, authority, request, logger) {
...
/*! @azure/msal-node v5.4.0 2026-07-07 */ class ClientApplication {
  constructor(configuration) {
    ...
    }(configuration), this.cryptoProvider = new CryptoProvider, this.logger = new Logger(this.config.system.loggerOptions, name, "5.4.0"), 
...
/*! @azure/msal-node v5.4.0 2026-07-07 */ class LoopbackClient {
...
/*! @azure/msal-node v5.4.0 2026-07-07 */ class DeviceCodeClient extends BaseClient {
  constructor(configuration) {
    super(configuration);
  }
  async acquireToken(request) {
...
/*! @azure/msal-node v5.4.0 2026-07-07 */ class PublicClientApplication extends ClientApplication {
  constructor(configuration) {
  ...
  async acquireTokenInteractive(request) {
    ...
    const {openBrowser: openBrowser, successTemplate: successTemplate, errorTemplate: errorTemplate, windowHandle: windowHandle, loopbackClient: customLoopbackClient, preferredPort: preferredPort, ...remainingProperties} = request;
    ...
    const {verifier: verifier, challenge: challenge} = await this.cryptoProvider.generatePkceCodes(), loopbackClient = customLoopbackClient || new LoopbackClient(preferredPort), responseMode = remainingProperties.responseMode ?? ResponseMode_QUERY;
...
/*! @azure/msal-node v5.4.0 2026-07-07 */ process.env.ProgramData, process.env.ProgramFiles;
