...
/*! @azure/msal-node v3.8.3 2025-11-19 */ class Serializer {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ const Constants$2 = {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ const DEFAULT_CRYPTO_IMPLEMENTATION = {
  createNewGuid: () => {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ var LogLevel;
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ class StringUtils {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ class ScopeSet {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ function buildClientInfo(rawClientInfo, base64Decode) {
  if (!rawClientInfo) {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ function tenantIdMatchesHomeTenant(tenantId, homeAccountId) {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ const AuthorityType_Default = 0, AuthorityType_Adfs = 1, AuthorityType_Dsts = 2, AuthorityType_Ciam = 3;

/*! @azure/msal-common v15.13.2 2025-11-19 */ function getTenantIdFromIdTokenClaims(idTokenClaims) {
  if (idTokenClaims) {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ const ProtocolMode_AAD = "AAD", ProtocolMode_OIDC = "OIDC";

/*! @azure/msal-common v15.13.2 2025-11-19 */ class AccountEntity {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ function extractTokenClaims(encodedToken, base64Decode) {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ function getDeserializedResponse(responseString) {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ class UrlString {
  get urlString() {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ const EndpointMetadata = {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ InstanceDiscoveryMetadata.metadata.forEach(metadataEntry => {
...
class CacheManager {
  constructor(clientId, cryptoImpl, logger, performanceClient, staticAuthorityOptions) {
    this.clientId = clientId, this.cryptoImpl = cryptoImpl, this.commonLogger = logger.clone("@azure/msal-common", "15.13.2"), 
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ const DEFAULT_SYSTEM_OPTIONS$1 = {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ const CcsCredentialType_HOME_ACCOUNT_ID = "home_account_id", CcsCredentialType_UPN = "UPN", RETURN_SPA_CODE = "return_spa_code", X_CLIENT_EXTRA_SKU = "x-client-xtra-sku";
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ function isCredentialEntity(entity) {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ RegionDiscovery.IMDS_OPTIONS = {
  headers: {
    Metadata: "true"
  }
};
...
class Authority {
  ...
  async getEndpointMetadataFromNetwork() {
    ...
    try {
      ...
      /*! @azure/msal-common v15.13.2 2025-11-19 */ (response.body);
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ Authority.reservedTenantDomains = new Set([ "{tenant}", "{tenantid}", AADAuthorityConstants_COMMON, AADAuthorityConstants_CONSUMERS, AADAuthorityConstants_ORGANIZATIONS ]);
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ function getRequestThumbprint(clientId, request, homeAccountId) {
  return {
    clientId: clientId,
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ class ThrottlingUtils {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ class NetworkError extends AuthError {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ class BaseClient {
  constructor(configuration, performanceClient) {
    this.config = function({authOptions: userAuthOptions, systemOptions: userSystemOptions, loggerOptions: userLoggerOption, cacheOptions: userCacheOptions, storageInterface: storageImplementation, networkInterface: networkImplementation, cryptoInterface: cryptoImplementation, clientCredentials: clientCredentials, libraryInfo: libraryInfo, telemetry: telemetry, serverTelemetryManager: serverTelemetryManager, persistencePlugin: persistencePlugin, serializableCache: serializableCache}) {
      ...
      var authOptions;
    }(configuration), this.logger = new Logger(this.config.loggerOptions, "@azure/msal-common", "15.13.2"), 
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ const noTokensFound = "no_tokens_found", nativeAccountUnavailable = "native_account_unavailable", refreshTokenExpired = "refresh_token_expired", uxNotAllowed = "ux_not_allowed", badToken = "bad_token", InteractionRequiredServerErrorMessage = [ "interaction_required", "consent_required", "login_required", "bad_token", "ux_not_allowed" ], InteractionRequiredAuthSubErrorMessage = [ "message_only", "additional_action", "basic_action", "user_password_expired", "consent_required", "bad_token" ], InteractionRequiredAuthErrorMessages = {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ class ProtocolUtils {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ const KeyLocation_SW = "sw";
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ class TokenCacheContext {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ class ResponseHandler {
  ...
  generateCacheRecord(serverTokenResponse, authority, reqTimestamp, request, idTokenClaims, userAssertionHash, authCodePayload) {
    ...
    /*! @azure/msal-common v15.13.2 2025-11-19 */ (this.cacheStorage, authority, this.homeAccountIdentifier, this.cryptoObj.base64Decode, request.correlationId, idTokenClaims, serverTokenResponse.client_info, env, claimsTenantId, authCodePayload, void 0, this.logger));
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ class AuthorizationCodeClient extends BaseClient {
  constructor(configuration, performanceClient) {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ class RefreshTokenClient extends BaseClient {
  constructor(configuration, performanceClient) {
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ class SilentFlowClient extends BaseClient {
  constructor(configuration, performanceClient) {
    super(configuration, performanceClient);
  }
...
/*! @azure/msal-common v15.13.2 2025-11-19 */ function getStandardAuthorizeRequestParameters(authOptions, request, logger, performanceClient) {
  ...
  function(parameters, responseMode) {
    ...
    if (request.sid && request.prompt === PromptValue_NONE) {
      ...
      /*! @azure/msal-common v15.13.2 2025-11-19 */ (request.account);
...
/*! @azure/msal-node v3.8.3 2025-11-19 */ class Deserializer {
...
/*! @azure/msal-node v3.8.3 2025-11-19 */ const HttpMethod_GET = "get", HttpMethod_POST = "post", ProxyStatus = {
...
/*! @azure/msal-node v3.8.3 2025-11-19 */ const name = "@azure/msal-node";
...
class HttpClient {
  constructor(proxyUrl, customAgentOptions, loggerOptions) {
    ...
    }, this.shouldDestroyRequest = (statusCode, networkResponse) => (statusCode < HttpStatus_SUCCESS_RANGE_START || statusCode > HttpStatus_SUCCESS_RANGE_END) && !(networkResponse.body && "object" == typeof networkResponse.body && "error" in networkResponse.body && networkResponse.body.error === Constants$1_AUTHORIZATION_PENDING), 
    this.proxyUrl = proxyUrl || "", this.customAgentOptions = customAgentOptions || {}, 
    this.logger = new Logger(loggerOptions || {}, name, "3.8.3"), this.isPiiEnabled = this.logger.isPiiLoggingEnabled();
  }
...
/*! @azure/msal-node v3.8.3 2025-11-19 */ const NodeAuthErrorMessage_invalidLoopbackAddressType = {
...
/*! @azure/msal-node v3.8.3 2025-11-19 */ const DEFAULT_AUTH_OPTIONS = {
...
/*! @azure/msal-node v3.8.3 2025-11-19 */ class GuidGenerator {
  generateGuid() {
    return v4();
  }
  isGuid(guid) {
...
/*! @azure/msal-node v3.8.3 2025-11-19 */ class EncodingUtils {
...
/*! @azure/msal-node v3.8.3 2025-11-19 */ class HashUtils {
  sha256(buffer) {
    return crypto$1.createHash(Hash_SHA256).update(buffer).digest();
  }
}

/*! @azure/msal-node v3.8.3 2025-11-19 */ class PkceGenerator {
  constructor() {
...
/*! @azure/msal-node v3.8.3 2025-11-19 */ class CryptoProvider {
  constructor() {
...
/*! @azure/msal-node v3.8.3 2025-11-19 */ const defaultSerializedCache_Account = {}, defaultSerializedCache_IdToken = {}, defaultSerializedCache_AccessToken = {}, defaultSerializedCache_RefreshToken = {}, defaultSerializedCache_AppMetadata = {};
...
/*! @azure/msal-node v3.8.3 2025-11-19 */ class UsernamePasswordClient extends BaseClient {
...
/*! @azure/msal-node v3.8.3 2025-11-19 */ function getAuthCodeRequestUrl(config, authority, request, logger) {
...
/*! @azure/msal-node v3.8.3 2025-11-19 */ class ClientApplication {
  constructor(configuration) {
    ...
    }(configuration), this.cryptoProvider = new CryptoProvider, this.logger = new Logger(this.config.system.loggerOptions, name, "3.8.3"), 
...
/*! @azure/msal-node v3.8.3 2025-11-19 */ class LoopbackClient {
...
/*! @azure/msal-node v3.8.3 2025-11-19 */ class DeviceCodeClient extends BaseClient {
  constructor(configuration) {
    super(configuration);
  }
  async acquireToken(request) {
...
/*! @azure/msal-node v3.8.3 2025-11-19 */ class PublicClientApplication extends ClientApplication {
  constructor(configuration) {
...
/*! @azure/msal-node v3.8.3 2025-11-19 */ process.env.ProgramData, process.env.ProgramFiles;
